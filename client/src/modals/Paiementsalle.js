...
const Paiementsalle = (props) => {
 
    const {paiementsalle, setEnregistrement } = props
    console.log(paiementsalle)
        ...
        <div className="container-fluid">
            ...
            <form>
                ...
                <FormControl className='col-md-6'>
                    {
                        !paiementsalle && <button className="btn btn-success" disabled={loading}  style={{marginRight:"10px"}}>
                        {loading && <Refresh/>} Enregistrer </button> 
                    }
                    {
                        paiementsalle && <button className="btn btn-success boutton-classe" >Modifier</button>
                    }
                </FormControl>
          </form>
        </div>
