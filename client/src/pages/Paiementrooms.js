...
import Paiementroom from "../modals/Paiementroom";


export const Paiementrooms = () =>{
  ...
  return (
    <div className='dashboard container-fluid'>
                ...
                <div className="page-title mt-3 ml-4">
                    ...
                    <div className="container-fluid">
                        <ol className="breadcrumb">
                            <li className="active"><i className="fa fa-dashboard"></i> Dashboard / Paiements Hotel</li>
                        </ol>
                    </div>                            
                </div>
            </div>
        ...
        <Popup
            title="Entrer les informations actuelles du Paiement Hotel"
            openPopup={openPopupModification}
            setOpenPopup={setOpenPopupModification}
            >  
                <Paiementroom paiementroom={dataModi} />
        </Popup>
        <Popup
        ...
        >  
            <Paiementroom data={dataToSave}/>
        </Popup>
    
        <Popup
        title="Enregistrement du Paiement Hotel"
        openPopup={openPopupForm}
        setOpenPopup={setOpenPopupForm}
        >  
            <Paiementroom paiementroom={undefined} setEnregistrement={setEnregistrement}/>
        </Popup>    
