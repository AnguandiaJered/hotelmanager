...
export const Classes = () =>{
  ...
  return (
    <div className='dashboard container-fluid'>
        ...
        <Popup
            title="Entrer les informations actuelles de la classe chambre"
            openPopup={openPopupModification}
            setOpenPopup={setOpenPopupModification}
            >  
                <Classe classe={dataModi} />
        </Popup>
        <Popup
        ...
        >  
            <Classe data={dataToSave}/>
        </Popup>
    
        <Popup
        title="Enregistrement de la classe chambre"
        openPopup={openPopupForm}
        setOpenPopup={setOpenPopupForm}
        >  
            <Classe classe={undefined} setEnregistrement={setEnregistrement}/>
        </Popup>    
